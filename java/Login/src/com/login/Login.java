...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 50, 280, 140));

        logoname.setFont(new java.awt.Font("Roboto Medium", 0, 24)); // NOI18N
        logoname.setForeground(new java.awt.Color(255, 255, 255));
        logoname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname.setText("Mic. \"El centro\"");
        bg.add(logoname, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 210, 280, -1));
        ...
        bg.add(citybg, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, -1, 420));
        ...
        favicon.setFont(new java.awt.Font("Roboto Medium", 1, 24)); // NOI18N
        ...
        bg.add(userTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 380, 30));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 370, 10));

        passLabel.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        passLabel.setText("CONTRASEÑA");
        bg.add(passLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 120, -1));
        ...
        bg.add(passTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 370, -1));

        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 370, 20));
        ...
        bg.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 380, 100, 30));
    ...
    private void userTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTxtMousePressed
        ...
        if (String.valueOf(userTxt.getText()).equals("Ingrese su nombre de usuario")){
            userTxt.setText("");
    ...
    private void passTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_passTxtMousePressed
        ...
        if (String.valueOf(userTxt.getText()).isEmpty()){
            userTxt.setText("Ingrese su nombre de usuario"); 
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        javax.swing.JOptionPane.showMessageDialog(this, "Intento de login con los datos: \nUsuario: " + String.valueOf(userTxt.getText()) + "\nContraseña: " + String.valueOf(passTxt.getText()), "LOGIN", javax.swing.JOptionPane.INFORMATION_MESSAGE);
